...
CREATE TABLE `employee_demographics` (
  ...
  `delegation_municipality` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_lxtqj4oyhxb5kwm3quobmxu12` (`employee_gral`),
  CONSTRAINT `FKg893suklh08k6qpon6ptcn6lo` FOREIGN KEY (`employee_gral`) REFERENCES `employee_gral` (`id`)
...
INSERT INTO `employee_demographics` VALUES (1,1,'Yucalpenten','2019-07-26 14:51:36','Tlalpan','2019-07-29 12:35:07','94700','CDMX','12121212',2);
...
-- Dump completed on 2019-09-02 14:30:20
