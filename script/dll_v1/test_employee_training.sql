...
CREATE TABLE `employee_training` (
  ...
  `other_expos_conferences` varchar(255) DEFAULT NULL,
  `soft_competitions` varchar(255) DEFAULT NULL,
  `technical_skills` varchar(255) DEFAULT NULL,
  `employee_gral_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKfbhhycer8wvyws3gyqep5q9ct` (`employee_gral_id`),
  CONSTRAINT `FKfbhhycer8wvyws3gyqep5q9ct` FOREIGN KEY (`employee_gral_id`) REFERENCES `employee_gral` (`id`)
